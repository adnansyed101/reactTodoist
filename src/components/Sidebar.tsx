...
const Sidebar = ({
  ...
  return (
    <div
      ...
      } absolute h-full w-2/3 bg-slate-100 p-5 duration-500 ease-out md:w-2/4 md:p-4 lg:static lg:block lg:w-full md lg:translate-x-0 lg:transition-none lg:mx-5 xl:p-10`}
    >
      <p
